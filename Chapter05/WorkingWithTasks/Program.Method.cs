...
partial class Program
{
    ...
    private static string CallStoredProdcedure(decimal amount)
    {
    ...
    private static void OuterMethod(bool attachedToParent = false)
    {
        TaskTitle("Outer method starting...");
        Task innerTask = attachedToParent ? Task.Factory.StartNew(InnerMethod, TaskCreationOptions.AttachedToParent) : Task.Factory.StartNew(InnerMethod);

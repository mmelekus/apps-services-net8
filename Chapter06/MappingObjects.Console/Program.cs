...
using System.Text; // To using Encoding.

// Set the console's output encoding to UTF-8 to support
// Unicode characters like the Euro currency symbol.
OutputEncoding = Encoding.UTF8; // OutputEncoding exists on System.Console, which is referenced globally and statically.
...
foreach (LineItem item in cart.Items) { WriteLine($"  {item}"); }
